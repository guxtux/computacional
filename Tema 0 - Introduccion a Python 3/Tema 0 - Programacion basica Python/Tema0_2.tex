...
\begin{exampleblock}{}
	...
	%\visible<2->{\textoazul{"Me alegra conocerte ", nombre}}}
\end{exampleblock}
...
\begin{exampleblock}{}<3->
	\verb|>>> print u, v| \\
	\visible<4->{\textcolor{blue}{\texttt{6543}  \texttt{1234.56789}}}
\end{exampleblock}
\begin{exampleblock}{}<5->
	\verb|>>> print "u = %6d" % u| \\
	\visible<6->{\textcolor{blue}{u=6543}}
\end{exampleblock}
\begin{exampleblock}{}<7->
	\verb|>>> print "u = %06d" % u| \\
	\visible<8->{\textcolor{blue}{\texttt{u=006543}}}
\end{exampleblock}
\end{frame}
\begin{frame}[fragile]
\frametitle{Formato de salida de datos}
\begin{exampleblock}{}<1->
	\verb|>>> print "v= %7.2f" % v| \\
	\visible<2->{\textcolor{blue}{\texttt{v=1234.57}}}
\end{exampleblock}
\begin{exampleblock}{}<3->
	\verb|>>> print "v= %9.2f" % v| \\
	\visible<4->{\textcolor{blue}{\texttt{$v=\hspace{0.5cm}1234.57$}}}
\end{exampleblock}
\begin{exampleblock}{}<5->
	\verb|>>> print "v= %7.8f" % v| \\
	\visible<6->{\textcolor{blue}{\texttt{v=1234.56789000}}}
\end{exampleblock}
\begin{exampleblock}{}<7->
	\verb|>>> print "v= %.2e" % v| \\
	\visible<8->{\textcolor{blue}{\texttt{v=1.23e+03}}}
\end{exampleblock}
\begin{exampleblock}{}<9->
	\verb|>>> print "u= %6d y v=%8.4e" %(u, v)| \\
	\visible<10->{\textcolor{blue}{\texttt{u = 6543 y v=1.2346e+03}}}
\end{exampleblock}
\end{frame}
\begin{frame}[fragile]
...
\\
\medskip
Introduce el c\'{o}digo por cada l\'{i}nea, presionando \texttt{Enter} para que se ejecute:
