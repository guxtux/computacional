...
plt.figure()
plt.title(u"Trayectoria del proyectil usando RK3")
...
plt.figure()
plt.title(u"Velocidad del proyectil usando RK3")
...
plt.figure()
plt.title(u"Posición del proyectil usando RK3")
