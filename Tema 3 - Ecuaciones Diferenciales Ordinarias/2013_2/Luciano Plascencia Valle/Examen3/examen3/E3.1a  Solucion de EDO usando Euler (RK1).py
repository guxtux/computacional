...
print "a) dy/dt = 1-t*y, y(0) = 1"
print "Solución: y(t) = exp(-t**2/2)*(1+sqrt(pi/2)*erfi(t/sqrt(2)))"
from ecdif import *
from scipy import integrate

def dy(y,t): return 1. - t*y
y0=1.
t0=0.; tn=5.; h=0.01

t=np.arange(t0,tn+h,h)
y=rk(1,dy,y0,t0,tn,h)
yexacta=integrate.odeint(dy,y0,t)
...
plt.title(u"Solución de la EDO dy/dt = 1-t*y, y(0) = 1")
