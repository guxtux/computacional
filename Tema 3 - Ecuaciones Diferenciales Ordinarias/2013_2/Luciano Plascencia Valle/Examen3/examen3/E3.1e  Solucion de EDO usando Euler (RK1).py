...
print "e) dy/dt = sin(t)-sqrt(abs(y)), y(0) = 1"
from ecdif import *
from scipy import integrate

def dy(y,t): return sin(t)-sqrt(abs(y))
y0=1.
t0=0.; tn=5.; h=0.01

t=np.arange(t0,tn+h,h)
y=rk(1,dy,y0,t0,tn,h)
yexacta=np.array(integrate.odeint(dy,y0,t))
...
plt.title(u"Solución de la EDO dy/dt = sin(t)-sqrt(abs(y)), y(0) = 1")
