...
Se calificarán sólo aquellas tareas con el $50\%$ de los ejercicios resueltos.
\end{exampleblock} 
\end{frame}
\begin{frame}
...
\item Que se hayan entregado las tres tareas con el mínimo del $\mathbf{50\%}$ de ejercicios resueltos.
\end{enumerate}
\end{frame}
\begin{frame}
...
\item Se entregaron las tres tareas con el mínimo del $\mathbf{50\%}$ de ejercicios resueltos.
\end{enumerate}
\end{frame}
\begin{frame}
