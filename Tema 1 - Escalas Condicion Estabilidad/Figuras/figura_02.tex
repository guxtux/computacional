...
\draw [fill=yellow!80!green, thin] (0, 3.5) circle (2);
\draw [align=center] (0, 3.5) node {Física \\ Teórica};

\draw[->, thick] (2.5, 3.5) -- (4.5, 3.5);

\draw [fill=pink!80, thin] (7, 3.5) circle (2);
\draw [align=center] (7, 3.5) node {Física \\ Experimental};
