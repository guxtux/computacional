...
print u'La función gamma(10), usando Romberg, tiene un valor,',I,'discretizando con',n,'puntos. Y se calculó un error de',abs(Ia-I)
print u'La función gamma(10), usando Simpson 1/3, tiene un valor,',Sim13(f,0.,100.,512),'Y se calculó un error de',abs(Ia-Sim13(f,0.,100.,512))
print u'La función gamma(1/2) tiene un valor,',I1,'discretizando con',n1,'puntos. Y se calculó un error de',abs(Ib-I1) 
